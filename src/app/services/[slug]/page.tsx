...
export const serviceData: Record<string, ServiceData> = {
  ...
  'product-management': {
    ...
    tagline: 'Move from idea to product with sharper requirements and cleaner delivery.',
    description: 'We help teams investigate opportunities, define the product, plan the build, organise delivery and prepare the materials required for launch.',
    features: [
      { title: 'Product Discovery', desc: 'Clarify the user, problem, opportunity, constraints and success measures before build work begins.' },
      { title: 'Requirements and Roadmaps', desc: 'Translate ideas into requirements, MVP scope, feature priorities and phased product plans.' },
      { title: 'Prototype and Workflow Planning', desc: 'Shape user journeys, operational flows and prototype requirements for design and development teams.' },
      { title: 'Delivery Coordination', desc: 'Support project rhythm, stakeholder alignment, documentation and launch readiness.' },
    ],
    offerings: [
      { name: 'Discovery Sprint', desc: 'A focused sprint to validate the opportunity and define the product direction.' },
      { name: 'Product Requirements Pack', desc: 'Clear requirements, workflows and acceptance criteria for build teams.' },
      { name: 'Launch Readiness Pack', desc: 'Positioning, documentation, go-live checklist and stakeholder materials.' },
      { name: 'Development Partner', desc: 'Ongoing product/project support from concept through delivery.' },
    ],
    personas: ['Founders', 'Operators', 'Product teams', 'Digital teams'],
