          ...
          <div className="contact-grid">
            ...
            <div className="reveal fade-up-delay-1">
              <div className="form-card">
                ...
                <form id="contact-form" action="https://formspree.io/f/xjgadeeq" method="POST" noValidate aria-label="Contact form">

                  <div className="form-grid-2">
                    <div className="form-group">
                      <label className="form-label" htmlFor="first-name">First Name <span style={{ color: '#e53e3e' }}>*</span></label>
                      <input className="form-control" type="text" id="first-name" name="first_name" placeholder="e.g. Adaeze" required autoComplete="given-name" />
                    </div>
                    <div className="form-group">
                      <label className="form-label" htmlFor="last-name">Last Name <span style={{ color: '#e53e3e' }}>*</span></label>
                      <input className="form-control" type="text" id="last-name" name="last_name" placeholder="e.g. Okonkwo" required autoComplete="family-name" />
                    </div>
                  </div>

                  <div className="form-group">
                    <label className="form-label" htmlFor="email">Email Address <span style={{ color: '#e53e3e' }}>*</span></label>
                    <input className="form-control" type="email" id="email" name="email" placeholder="you@yourcompany.com" required autoComplete="email" />
                  </div>

                  <div className="form-group">
                    <label className="form-label" htmlFor="phone">Phone / WhatsApp</label>
                    <input className="form-control" type="tel" id="phone" name="phone" placeholder="+234 XXX XXX XXXX" autoComplete="tel" />
                  </div>

                  <div className="form-group">
                    <label className="form-label" htmlFor="organization">Organization / Institution</label>
                    <input className="form-control" type="text" id="organization" name="organization" placeholder="Company or institution name" autoComplete="organization" />
                  </div>

                  <div className="form-group">
                    <label className="form-label" htmlFor="inquiry-type">Type of Inquiry <span style={{ color: '#e53e3e' }}>*</span></label>
                    <select className="form-control" id="inquiry-type" name="inquiry_type" required defaultValue="">
                  ...
                  <div className="form-group">
                    ...
                    <textarea className="form-control" id="message" name="message" placeholder="Please describe your project, challenge, or question in as much detail as you like..." required style={{ minHeight: '140px' }}></textarea>
                  </div>

                  <div className="form-group" style={{ display: 'flex', alignItems: 'flex-start', gap: 'var(--space-sm)' }}>
                    <input type="checkbox" id="newsletter-opt" name="newsletter" style={{ marginTop: '3px', width: '16px', height: '16px', accentColor: 'var(--clr-primary)', flexShrink: 0 }} />
                    <label htmlFor="newsletter-opt" style={{ fontSize: '0.83rem', color: 'var(--clr-text-muted)', cursor: 'pointer' }}>I would like to receive Ryters Spot's newsletter with insights on writing, strategy, and digital transformation.</label>
                  </div>

                  <button type="submit" className="btn btn-primary" style={{ width: '100%', justifyContent: 'center', padding: '0.9rem' }}>Send Message</button>
